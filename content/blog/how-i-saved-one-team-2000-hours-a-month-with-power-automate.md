...
- Confirmation times to vendors went from hours to minutes. A few vendors actually commented on the speed difference unprompted.
...
I don't always get to share numbers this clean, but when the volume is high and the process is repetitive, the math is pretty hard to ignore.
