  ...
  const steps = [
    {
      ...
      activities: [
        ...
        'Define the KPIs and what success looks like',
    ...
    },
    {
      ...
      activities: [
        ...
        'Write up the technical specs',
        'Plan out the development sprints',
      ],
      deliverables: [
    ...
    },
    {
      ...
      activities: [
        ...
        'Hand over all documentation and know-how',
        'Set up success metrics dashboard',
        'Plan what to improve after launch',
      ],
      deliverables: [
                  ...
                  <ul className="space-y-4">
                    {step.activities.map((activity, ai) => (
                      <li key={ai} className="flex items-start gap-3">
                        <svg className="w-4 h-4 text-apple-gray mt-1.5 flex-shrink-0" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2} aria-hidden="true">
